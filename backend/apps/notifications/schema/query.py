...
class Query(object):
  ...
  watcher = graphene.Field(WatcherType, id=graphene.Int(), authorization_code=graphene.String(), project_id=graphene.Int())
  ...
  def resolve_watcher(self, info, **kwargs):
    ...
    if project_id is not None:
      return Watcher.getOrCreateVigilantWatcherBy(project_id=project_id, user=info.context.user)
